...
const LoginPage = () => {
  ...
  return (
    <div className="w-full bg-white h-dvh text-black flex justify-center items-center overflow-hidden py-4">
      <div className="container flex h-full overflow-hidden ">
        <div className="w-1/2 bg-gray-400 relative lg:block hidden">
          <Swiper
        ...
        <div className="lg:w-1/2 w-full h-full flex-center overflow-auto ">
            ...
            >
              <Form className="w-full h-full px-4 flex-center flex-col items-start! ">
                ...
                <div className="w-full h-full flex flex-col gap-7.5">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-login-btn-color underline self-end"
                  >
                    Forgot Password?
                  </Link>
                  <button
